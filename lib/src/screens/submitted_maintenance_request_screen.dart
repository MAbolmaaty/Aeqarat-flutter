...
class SubmittedMaintenanceRequestScreen extends StatefulWidget {

  static Route<dynamic> route() => MaterialPageRoute(
      builder: (context) => SubmittedMaintenanceRequestScreen());

  @override
  _SubmittedMaintenanceRequestScreenState createState() => _SubmittedMaintenanceRequestScreenState();
}

class _SubmittedMaintenanceRequestScreenState extends State<SubmittedMaintenanceRequestScreen> {
  @override
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            AppLocalizations.of(context).maintenanceType,
                            style: TextStyle(
                                color: Colors.grey,
                                fontSize: 13,
                                fontWeight: FontWeight.bold),
