              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsets.only(top: 56.0, right: 16, left: 16),
                      child: Align(
                        ...
                        return TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              suffixIcon: GestureDetector(
                                ...
                                onTap: () {
                                  authenticationApi.changePasswordVisibility();
                                },
                              ),
                              alignLabelWithHint: true,
                              border: OutlineInputBorder(
                            ...
                            if (form.validate()) {
                              ...
                              authenticationApi
                                  ...
                                  .then((result) {if (result['status']) {
                                    AuthenticationResponseModel authenticationResponseModel = result['data'];
                                    saveApiToken(authenticationResponseModel.jwt);
                              }});
                            }
                          },
                          child: Container(
